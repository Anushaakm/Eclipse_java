...
public class Home {
		...
		public Home(String name, int no,long phone, String location, String city, String[] familyMembers, int[] noOfKids, int[] noOfpets,String[] names, int[] ages, int[] pincode)
		{
